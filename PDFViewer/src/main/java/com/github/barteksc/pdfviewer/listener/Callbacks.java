...
public class Callbacks {
    ...
    /**
     * Call back object to call when search complete
     */
    ...
    public void setOnZoomAnimationUpdate(OnZoomAnimationUpdate onZoomAnimationUpdate) {
        this.onZoomAnimationUpdate = onZoomAnimationUpdate;
    }

    public void callOnSearchListener() {
        if (onSearchListener != null) {
            onSearchListener.onSearchComplete();
        }
    }

    public void callOnSelectListener() {
        if (onSelectListener != null) {
            onSelectListener.onSelection();
        }
    }

    public void setOnCopySelectedListener(OnCopySelectedListener onCopySelectedListener) {
        this.onCopySelectedListener = onCopySelectedListener;
    }

    public void callOnCopySelectedListener(String text) {
        if (onCopySelectedListener != null) {
            onCopySelectedListener.onCopySelected(text);
        }
    }

    public void callOnZoomAnimationUpdate() {
        if (onZoomAnimationUpdate != null) {
            onZoomAnimationUpdate.onZoomUpdate();
        }
    }
